defmodule TemporalSdk.Service do
  ...
  defdelegate reset_workflow(cluster, workflow_execution), to: :temporal_sdk_service
  defdelegate reset_workflow(cluster, workflow_execution, opts), to: :temporal_sdk_service
end
