-module(temporal_sdk_test_replay_activity_session_eager_execution_tests).
...
-define(OPTS, [session_execution, eager_execution]).
-define(LPATH, [json, activity_session_eager_execution]).
