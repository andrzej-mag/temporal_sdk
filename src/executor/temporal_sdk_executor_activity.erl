...
init([ApiContext, Task, WorkflowExecutorPid]) ->
    ...
    #{
        ...
        workflow_execution := #{workflow_id := WorkflowId, run_id := WorkflowRunId},
...
fetch_header_data(Task, ApiContext) ->
    Header = temporal_sdk_api_activity_task:header(ApiContext, Task),
